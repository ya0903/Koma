...
class AddServerViewModelTest {
    ...
    private class FakeMediaServer(override val id: String) : MediaServer {
        ...
        override suspend fun onDeckBooks(libraryId: String?) = emptyList<com.koma.client.domain.model.Book>()
        override suspend fun recentlyAddedSeries(libraryId: String?) = emptyList<com.koma.client.domain.model.Series>()
        override suspend fun recentlyUpdatedSeries(libraryId: String?) = emptyList<com.koma.client.domain.model.Series>()
        override suspend fun recentlyAddedBooks(libraryId: String?) = emptyList<com.koma.client.domain.model.Book>()
        override suspend fun recentlyReleasedBooks(libraryId: String?) = emptyList<com.koma.client.domain.model.Book>()
        override suspend fun recentlyReadBooks(libraryId: String?) = emptyList<com.koma.client.domain.model.Book>()
