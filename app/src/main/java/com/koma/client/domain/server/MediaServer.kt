...
interface MediaServer {
    ...
    suspend fun onDeckBooks(): List<Book>
    suspend fun recentlyAddedSeries(): List<Series>
    suspend fun recentlyUpdatedSeries(): List<Series>
    suspend fun recentlyAddedBooks(): List<Book>
    suspend fun recentlyReleasedBooks(): List<Book>
    suspend fun recentlyReadBooks(): List<Book>
